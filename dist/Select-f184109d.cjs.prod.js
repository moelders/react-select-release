...
for (var _ref = {
  ...
  var ariaSelection = props.ariaSelection, focusedOption = props.focusedOption, focusedValue = props.focusedValue, focusableOptions = props.focusableOptions, isFocused = props.isFocused, selectValue = props.selectValue, selectProps = props.selectProps, ariaLiveMessages = selectProps.ariaLiveMessages, getOptionLabel = selectProps.getOptionLabel, inputValue = selectProps.inputValue, isMulti = selectProps.isMulti, isOptionDisabled = selectProps.isOptionDisabled, isSearchable = selectProps.isSearchable, menuIsOpen = selectProps.menuIsOpen, options = selectProps.options, screenReaderStatus = selectProps.screenReaderStatus, tabSelectsValue = selectProps.tabSelectsValue, ariaLabel = selectProps["aria-label"], ariaLive = selectProps["aria-live"], messages = React.useMemo((function() {
    ...
    return guidanceMsg;
  }), [ ariaLabel, focusedOption, focusedValue, isMulti, isOptionDisabled, isSearchable, menuIsOpen, messages, selectValue, tabSelectsValue ]), ariaContext = "".concat(ariaFocused, " ").concat(ariaResults, " ").concat(ariaGuidance);
...
function DummyInput(_ref) {
  var innerRef = _ref.innerRef, props = _objectWithoutProperties__default.default(_ref, [ "innerRef" ]);
...
var shouldHideSelectedOptions = function(props) {
  ...
  return _createClass__default.default(Select, [ {
    ...
    key: "renderInput",
    value: function(inputInMenu, menuPlacement) {
      var _this$props8 = this.props, isDisabled = _this$props8.isDisabled, isSearchable = _this$props8.isSearchable, inputId = _this$props8.inputId, inputValue = _this$props8.inputValue, menuIsOpen = _this$props8.menuIsOpen, tabIndex = _this$props8.tabIndex, form = _this$props8.form, searchInMenu = _this$props8.searchInMenu, Input = this.getComponents().Input, inputIsHidden = this.state.inputIsHidden, commonProps = this.commonProps, id = inputId || this.getElementId("input"), ariaAttributes = {
        "aria-autocomplete": "list",
        "aria-label": this.props["aria-label"],
        "aria-labelledby": this.props["aria-labelledby"]
      };
      return inputInMenu || isSearchable && (!searchInMenu || menuIsOpen) ? React__default.default.createElement(Input, _extends__default.default({}, commonProps, {
        autoCapitalize: "none",
        autoComplete: "off",
        autoCorrect: "off",
    ...
    value: function() {
      ...
      if (this.hasOptions()) menuUI = this.getCategorizedOptions().map((function(item) {
        ...
        menuUI = message && React__default.default.createElement(LoadingMessage, commonProps, message);
      } else {
        var _message = noOptionsMessage({
          inputValue: inputValue
        });
        menuUI = _message && React__default.default.createElement(NoOptionsMessage, commonProps, _message);
      }
      var menuPlacementProps = {
        ...
        var ref = _ref4.ref, _ref4$placerProps = _ref4.placerProps, placement = _ref4$placerProps.placement, maxHeight = _ref4$placerProps.maxHeight, menuInput = isSearchable && searchInMenu && _this4.renderInput(!0, placement);
        return React__default.default.createElement(Menu, _extends__default.default({}, commonProps, menuPlacementProps, {
          ...
          isLoading: isLoading,
          placement: placement
        }), "bottom" === placement && menuInput, React__default.default.createElement(ScrollManager, {
    ...
    value: function() {
      ...
      return React__default.default.createElement(SelectContainer, _extends__default.default({}, commonProps, {
        ...
        isDisabled: isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput(!1)), React__default.default.createElement(IndicatorsContainer, _extends__default.default({}, commonProps, {
        isDisabled: isDisabled
    ...
    value: function(props, state) {
      ...
      if (prevProps && (value !== prevProps.value || options !== prevProps.options || menuIsOpen !== prevProps.menuIsOpen || inputValue !== prevProps.inputValue)) {
        var _selectValue2 = index.cleanValue(value), focusableOptions = menuIsOpen ? buildFocusableOptions(props, _selectValue2) : [], focusedValue = clearFocusValueOnUpdate ? getNextFocusedValue(state, _selectValue2) : null;
        newMenuOptionsState = {
