import React, { Component, FocusEventHandler, FormEventHandler, KeyboardEventHandler, MouseEventHandler, ReactNode, RefCallback, TouchEventHandler } from 'react';
import { FilterOptionOption } from './filters';
import { AriaLive, AriaLiveMessages, AriaSelection } from './accessibility/index';
...
export default class Select<Option extends OptionBase = OptionBase, IsMulti extends boolean = false, Group extends GroupBase<Option> = GroupBase<Option>> extends Component<Props<Option, IsMulti, Group>, State<Option, IsMulti, Group>> {
    ...
    onKeyDown: KeyboardEventHandler<HTMLDivElement>;
    renderInput(inputInMenu: boolean, menuPlacement?: string): JSX.Element;
