...
export declare function getMenuPlacement({ maxHeight, menuEl, minHeight, placement, searchInMenu, shouldScroll, isFixedPosition, theme, }: PlacementArgs): MenuState;
