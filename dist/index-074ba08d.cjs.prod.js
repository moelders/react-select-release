...
function getMenuPlacement(_ref) {
  var _menuEl$querySelector, _menuEl$querySelector2, maxHeight = _ref.maxHeight, menuEl = _ref.menuEl, minHeight = _ref.minHeight, placement = _ref.placement, searchInMenu = _ref.searchInMenu, shouldScroll = _ref.shouldScroll, isFixedPosition = _ref.isFixedPosition, spacing = _ref.theme.spacing, scrollParent = getScrollParent(menuEl), defaultState = {
    placement: "bottom",
    maxHeight: maxHeight
  };
  if (!menuEl || !menuEl.offsetParent) return defaultState;
  var scrollHeight = scrollParent.getBoundingClientRect().height, _menuEl$getBoundingCl = menuEl.getBoundingClientRect(), menuBottom = _menuEl$getBoundingCl.bottom, menuHeight = _menuEl$getBoundingCl.height, menuTop = _menuEl$getBoundingCl.top, searchHeight = searchInMenu && (null === (_menuEl$querySelector = menuEl.querySelector(".search-in-menu")) || void 0 === _menuEl$querySelector || null === (_menuEl$querySelector2 = _menuEl$querySelector.parentElement) || void 0 === _menuEl$querySelector2 ? void 0 : _menuEl$querySelector2.offsetHeight) || 0, containerTop = menuEl.offsetParent.getBoundingClientRect().top, viewHeight = window.innerHeight, scrollTop = getScrollTop(scrollParent), marginBottom = parseInt(getComputedStyle(menuEl).marginBottom, 10) + searchHeight, marginTop = parseInt(getComputedStyle(menuEl).marginTop, 10) + searchHeight, viewSpaceAbove = containerTop - marginTop, viewSpaceBelow = viewHeight - menuTop, scrollSpaceAbove = viewSpaceAbove + scrollTop, scrollSpaceBelow = scrollHeight - scrollTop - menuTop, scrollDown = menuBottom - viewHeight + scrollTop + marginBottom, scrollUp = scrollTop + menuTop - marginTop;
  switch (placement) {
   case "auto":
   case "bottom":
...
var coercePlacement = function(p) {
  ...
  function MenuPlacer() {
    ...
    return (_this = _super.call.apply(_super, [ this ].concat(args))).state = {
      ...
      var _this$props = _this.props, minMenuHeight = _this$props.minMenuHeight, maxMenuHeight = _this$props.maxMenuHeight, menuPlacement = _this$props.menuPlacement, menuPosition = _this$props.menuPosition, menuShouldScrollIntoView = _this$props.menuShouldScrollIntoView, searchInMenu = _this$props.searchInMenu, theme = _this$props.theme;
      if (ref) {
...
var css$1 = function(_ref) {
  ...
  var isDisabled = _ref.isDisabled, searchInMenu = _ref.searchInMenu, menuPlacement = _ref.menuPlacement, _ref$theme = _ref.theme, spacing = _ref$theme.spacing, colors = _ref$theme.colors;
  return {
    borderTop: searchInMenu && "top" === menuPlacement ? "1px solid hsla(0, 0%, 0%, 0.1)" : 0,
    borderBottom: searchInMenu && "bottom" === menuPlacement ? "1px solid hsla(0, 0%, 0%, 0.1)" : 0,
    margin: searchInMenu ? "".concat(spacing.baseUnit / 2, "px 0") : spacing.baseUnit / 2,
...
}, inputStyle = function(_ref2) {
  return {
    label: "input",
    background: 0,
    border: 0,
    fontSize: "inherit",
    opacity: _ref2.isHidden ? 0 : 1,
    outline: 0,
    padding: _ref2.searchInMenu ? "0 0 0 8px" : 0,
    color: "inherit"
  };
}, Input = function(props) {
  var className = props.className, cx = props.cx, getStyles = props.getStyles, _cleanCommonProps = cleanCommonProps(props), innerRef = _cleanCommonProps.innerRef, isDisabled = _cleanCommonProps.isDisabled, isHidden = _cleanCommonProps.isHidden, searchInMenu = _cleanCommonProps.searchInMenu;
  _cleanCommonProps.menuPlacement;
  var innerProps = _objectWithoutProperties__default.default(_cleanCommonProps, [ "innerRef", "isDisabled", "isHidden", "searchInMenu", "menuPlacement" ]);
  return react.jsx("div", {
    css: getStyles("input", props)
  }, react.jsx(AutosizeInput__default.default, _extends__default.default({
    className: cx({
      input: !0
    }, "".concat(className || "", " search-in-").concat(searchInMenu ? "menu" : "input")),
    inputRef: innerRef,
